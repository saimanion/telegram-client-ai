...
//       console.log('Ваш projectId успешно отработал.')
//       try {
//         console.log('Начинаем генерировать ответ')
//         const vertexAI = new VertexAI({project: projectId, location: 'us-central1'});
//         'Создан объект Вкртекс ии'
//       const generativeModel = vertexAI.getGenerativeModel({
//         model: 'gemini-1.5-flash-001',
//       });
//       console.log(' Вкртекс ии использует модель gemini-1.5-flash-001 ')
...
//       await client.sendMessage("kolaok", { message: response });
//       }
